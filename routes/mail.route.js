...
<div style="font-family: inherit; text-align: center"><span style="font-family: inherit">${data.ingredients}</span></div><div></div></div></td>
  ...
  router.post('/business', async (req, res) => {
    ...
    <![endif]-->
      ...
      <tr>
        <td role="module-content">
          <p>¡Una empresa te ha contactado!</p>
        </td>
      </tr>
    </table><table class="module" role="module" data-type="text" border="0" cellpadding="0" cellspacing="0" width="100%" style="table-layout: fixed;" data-muid="c975a4a6-52f6-4b36-b7b6-d2cab7536674" data-mc-module-version="2019-10-22">
      <tbody>
        <tr>
          <td style="padding:18px 0px 18px 0px; line-height:22px; text-align:inherit;" height="100%" valign="top" bgcolor="" role="module-content"><div><div style="font-family: inherit; text-align: center"><br></div>
    <div style="font-family: inherit; text-align: inherit"><span style="font-family: inherit">¡Hola, administrador!</span></div>
    <div style="font-family: inherit; text-align: inherit"><span style="font-family: inherit">Una nueva empresa te ha contactado...</span></div>
    <div style="font-family: inherit; text-align: justify"><br></div>
    <div style="font-family: inherit; text-align: justify"><br></div><div></div></div></td>
        </tr>
      </tbody>
      ...
      <tbody>
        <tr>
          <td style="padding:18px 0px 18px 0px; line-height:22px; text-align:inherit;" height="100%" valign="top" bgcolor="" role="module-content"><div><div style="font-family: inherit; text-align: center"><span style="font-family: inherit"><strong>${data.name}</strong></span></div>
    <div style="font-family: inherit; text-align: center"><span style="font-family: inherit"><em>Publicado por @${data.username} (${data.useremail})</em></span></div>
    <div style="font-family: inherit; text-align: center"><br></div>
    <div style="font-family: inherit; text-align: justify"><span style="white-space: pre-line; white-space: pre-wrap; font-family: inherit">${data.info}</span></div>
    <div style="font-family: inherit; text-align: center"><br></div>
    <div style="font-family: inherit; text-align: center"><span style="font-family: inherit">email de contacto: ${data.email} - número de contacto: ${data.phone}</span></div>
    ...
    let infoClient = await transporter.sendMail({
        from: '"Drinkly Team" <drinkly.official@gmail.com>',
        to: 'drinkly.official@gmail.com', 
        subject: "¡Una empresa te ha contactado!", 
        text: "¡Una empresa te ha contactado!", 
        html: output, 
    });
...
<![endif]-->
  ...
  <![endif]-->
    ...
    <tbody>
      <tr>
        <td style="padding:18px 0px 18px 0px; line-height:22px; text-align:inherit;" height="100%" valign="top" bgcolor="" role="module-content"><div><div style="font-family: inherit; text-align: center"><br></div>
<div style="font-family: inherit; text-align: inherit"><span style="font-family: inherit">¡Hola, ${data.user_fname}!</span></div>
<div style="font-family: inherit; text-align: inherit"><span style="font-family: inherit">Ya recibimos tu mensaje. Lo más pronto posible un administrador se encargará de contactarte y atender tus requerimientos.</span></div>
<div style="font-family: inherit; text-align: inherit"><span style="font-family: inherit"><em>A continuación te presentamos el mensaje que publicaste...</em></span></div>
<div style="font-family: inherit; text-align: justify"><br></div>
<div style="font-family: inherit; text-align: justify"><br></div><div></div></div></td>
      </tr>
    </tbody>
